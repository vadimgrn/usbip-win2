...
*/
        ...
        WdfDeviceInitSetFileObjectConfig(init, &fobj_cfg, WDF_NO_OBJECT_ATTRIBUTES);
...
_IRQL_requires_same_
_IRQL_requires_(PASSIVE_LEVEL)
PAGED NTSTATUS usbip::DriverDeviceAdd(_In_ WDFDRIVER, _Inout_ WDFDEVICE_INIT *init)
{
        PAGED_CODE();
