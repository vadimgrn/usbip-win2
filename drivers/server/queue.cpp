...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, serverQueueInitialize)
#endif

NTSTATUS
serverQueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = serverEvtIoDeviceControl;
    queueConfig.EvtIoStop = serverEvtIoStop;
