 ...
 * @return 0 to 15
 */
constexpr auto usb_endpoint_num(_In_ const USB_ENDPOINT_DESCRIPTOR &epd)
{
	return epd.bEndpointAddress & USB_ENDPOINT_ADDRESS_MASK;
}

constexpr auto usb_endpoint_type(_In_ const USB_ENDPOINT_DESCRIPTOR &epd)
{
...
constexpr bool usb_endpoint_dir_in(_In_ const USB_ENDPOINT_DESCRIPTOR &epd)
{
	return USB_ENDPOINT_DIRECTION_IN(epd.bEndpointAddress);
}

constexpr bool usb_endpoint_dir_out(_In_ const USB_ENDPOINT_DESCRIPTOR &epd)
{
 ...
 */
constexpr auto usb_default_control_pipe(_In_ const USB_ENDPOINT_DESCRIPTOR &epd)
{
