...
public:
         ...
         */
        explicit ctrl_c_guard(_In_ HANDLE dev) noexcept;
         ...
         */
        explicit ctrl_c_guard(_Inout_ std::stop_source &ssrc) noexcept;
         ...
         */
        std::stop_token token() const noexcept { return m_token; }
        operator std::stop_token() const noexcept { return m_token; }
